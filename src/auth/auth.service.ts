...
import { EntrenadorProfileService } from '../entrenador-profile/entrenador-profile.service';
...
export class AuthService implements OnModuleInit {
  constructor(
    ...
    private entrenadorProfileService: EntrenadorProfileService,
  ) {}
    ...
    try {
      ...
      case Role.USUARIO:
        await this.usuarioProfileService.create(userId, {
          ...
          objetivos: registerDto.objetivos,
        });
        break;
      case Role.ENTRENADOR:
        await this.entrenadorProfileService.create(userId, {
